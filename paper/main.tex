...
$8.6\times10^{-4}$ (Shard~2). After Holm correction across the five
Shard-2 tests in Table~\ref{tab:verification}, every reported difference
except the rotation$+xy$ row (B4, $p=0.50$) remains significant at
$\alpha=0.05$.
...
90.2\,/\,98.4 on Shard~2), a significant paired difference ($p=0.021$;
Holm-adjusted $0.042$). We nonetheless keep the two-threshold rule as the
deployed default: it is interpretable, and it favors recall --- in
...
B10 & Learned classifier (LR, train S1) & --- & 98.0 / 95.6 / 96.8 & \todo{S3} & 0.993 & 0.021 \\
\midrule
